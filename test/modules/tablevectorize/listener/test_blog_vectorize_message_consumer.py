"""Tests for blog vectorize message consumer."""
...
def _build_valid_payload() -> dict[str, Any]:
    """Build valid camelCase payload for blog dto."""
    return {
        "operation": "UPDATE",
        "id": 401,
        "shopId": 501,
...
def test_parse_payload_success_and_missing_required() -> None:
    ...
    from modules.table_vectorize.listener.blog_vectorize_message_consumer import (
    ...
    consumer = BlogVectorizeMessageConsumer(FakeService(), FakeProducer())
...
def test_requeue_payload_increments_retry_count() -> None:
    ...
    consumer = BlogVectorizeMessageConsumer(FakeService(), producer)
